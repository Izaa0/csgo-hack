...
namespace hazedumper {
	...
	namespace signatures {
		...
		constexpr uintptr_t dwEntityList = 0x4DFFF7C;
		constexpr uintptr_t dwForceAttack = 0x322DDE8;
		constexpr uintptr_t dwForceAttack2 = 0x322DDF4;
		constexpr uintptr_t dwForceBackward = 0x322DE30;
		constexpr uintptr_t dwForceForward = 0x322DE24;
		constexpr uintptr_t dwForceJump = 0x52BBCD8;
		constexpr uintptr_t dwForceLeft = 0x322DDA0;
		constexpr uintptr_t dwForceRight = 0x322DDAC;
		constexpr uintptr_t dwGameDir = 0x63AD80;
		constexpr uintptr_t dwGameRulesProxy = 0x532F4E4;
		constexpr uintptr_t dwGetAllClasses = 0xE0BF94;
		constexpr uintptr_t dwGlobalVars = 0x59EE60;
		constexpr uintptr_t dwGlowObjectManager = 0x535AA08;
		constexpr uintptr_t dwInput = 0x525D550;
		constexpr uintptr_t dwInterfaceLinkList = 0x99B4A4;
		constexpr uintptr_t dwLocalPlayer = 0xDEA98C;
		constexpr uintptr_t dwMouseEnable = 0x52391B0;
		constexpr uintptr_t dwMouseEnablePtr = 0x5239180;
		constexpr uintptr_t dwPlayerResource = 0x322C120;
		constexpr uintptr_t dwRadarBase = 0x5236A54;
		constexpr uintptr_t dwSensitivity = 0xDEEBA8;
		constexpr uintptr_t dwSensitivityPtr = 0xDEEBA8;
		constexpr uintptr_t dwSetClanTag = 0x8DA80;
		constexpr uintptr_t dwViewMatrix = 0x4DF0DC4;
		constexpr uintptr_t dwWeaponTable = 0x525E62C;
		constexpr uintptr_t dwWeaponTableIndex = 0x326C;
		constexpr uintptr_t dwYawPtr = 0xDEE938;
		constexpr uintptr_t dwZoomSensitivityRatioPtr = 0xDF43A8;
		constexpr uintptr_t dwbSendPackets = 0xDD2B2;
		constexpr uintptr_t dwppDirect3DDevice9 = 0xA62C0;
		constexpr uintptr_t find_hud_element = 0x58B402D0;
		constexpr uintptr_t force_update_spectator_glow = 0x3D997A;
		constexpr uintptr_t interface_engine_cvar = 0x3FA9C;
		constexpr uintptr_t is_c4_owner = 0x3E71A0;
		...
		constexpr uintptr_t m_pitchClassPtr = 0x52390A8;
		constexpr uintptr_t m_yawClassPtr = 0xDEE938;
		constexpr uintptr_t model_ambient_min = 0x5A1194;
		constexpr uintptr_t set_abs_angles = 0x1E7A10;
		constexpr uintptr_t set_abs_origin = 0x1E7850;
	} // namespace signatures
} // namespace hazedumper